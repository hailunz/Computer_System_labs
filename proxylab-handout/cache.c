...
/*       if ( delete_cache_node(list_head)<0){
            pthread_rwlock_unlock(&wrlock);
            return -1;
       }
*/
...
/*    if (add_cache_node(list_head, node)<0){
        pthread_rwlock_unlock(&wrlock);
        return -1;
    }
*/    
